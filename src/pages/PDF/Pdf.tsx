...
const Pdf: React.FC = () => {
  ...
  const fetchFaktura = async () => {
    try {
      ...
      const response = await axiosClient.get(`/faktura/show/${encoded}`);
  ...
  const handleDownloadPDF = async () => {
    ...
    const safeFilename = `Faktura${(br_faktura ?? "").replace(/\//g, "_")}.pdf`;
      ...
      <div className="invoice-form" ref={invoiceRef}>
        ...
        <section>
          ...
          <table>
            <tbody>
              <tr>
                <td>Број на фактура:</td>
                <td>{faktura?.br_faktura}</td>
              </tr>
              <tr>
                <td>Архивски број:</td>
                <td>{faktura?.tehnicki_sekretar.arhivski_br}</td>
              </tr>
              <tr>
                <td>Издавач на фактура:</td>
                <td>{faktura?.tehnicki_sekretar.izdavaci_id}</td>
              </tr>
              <tr>
                <td>Износ на договор:</td>
                <td>{faktura?.tehnicki_sekretar.iznos_dogovor}</td>
              </tr>
              <tr>
                <td>Датум:</td>
              ...
              <tr>
                <td>Потпис:</td>
                <td>
                  {faktura?.tehnicki_sekretar.submited_by.name ??
                    faktura?.tehnicki_sekretar.updated_by.name}
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <section className="invoice-section">
          ...
          <table>
            <tbody>
              <tr>
                <td>
                  Содржината на фактурата, предметот на наплатата е согласно:
                </td>
              ...
              {faktura?.tip_nabavka.tip === "javna" ? (
                <>
                  ...
                  <tr>
                    <td>
                      Останати расположливи средства по договорот (без вкл. на
                      фак.):
                    </td>
                    <td>
                      {
                        faktura?.tip_nabavka.javna_nabavka
                          ?.ostanati_rasp_sredstva
                      }
                    </td>
                  </tr>
                  <tr>
                    <td>
                      Опис на сите ставки и единичната цена на фактурата,
                      согласно договорот:
                    </td>
                    <td>
                      {faktura?.tip_nabavka.javna_nabavka?.soglasno_dogovor}
                    </td>
                  </tr>
                  <tr>
                    <td>Датум:</td>
                  ...
                  <tr>
                    <td>Потпис:</td>
                    <td>
                      {faktura?.tip_nabavka.submited_by.name ??
                        faktura?.tip_nabavka.updated_by.name}
                    </td>
                  </tr>
                </>
              ) : (
        ...
        <section className="invoice-section">
          ...
          <table>
            <tbody>
              ...
              <tr>
                <td>
                  <b>Предлог за евиденција на трошокот</b>
                </td>
                <td></td>
              </tr>
              <tr>
              ...
              <tr>
                <td>Потпис:</td>
                <td>
                  {faktura?.baratel_javna_nabavka.submited_by.name ??
                    faktura?.baratel_javna_nabavka.updated_by.name}
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td>
                  {faktura?.smetkovodstvo.osnova_evidentiranje ? "Да" : "Не"}
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td>
                  Средства се внесени (поединечно) како новонабавени за
                  тековната година:
                </td>
                <td>
                  {faktura?.smetkovodstvo.vneseni_sredstva ? "Да" : "Не"}{" "}
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td>Потпис:</td>
                <td>
                  {faktura?.smetkovodstvo.submited_by.name ??
                    faktura?.smetkovodstvo.updated_by.name}
                </td>
              </tr>
            </tbody>
          </table>
